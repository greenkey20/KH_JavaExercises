...
public class A_If {
	...
	public void method1() {
		...
		if(num < 0) {System.out.println(num + "는/은 음수입니다.");} // 실행 코드 짧은 경우 이렇게 써도 됨; 실행 코드 2줄 이상 되면 위와 같이 쓰기; 언제나 가독성 좋은 방식으로 쓰기
...
//		}
	...
	public void method3() {
		...
		// 							   순서 = index 0 1 2 3 4 5 6... (index는 0번부터 시작)
...
//			if(gender == '2' || gender == '4') {System.out.println("여자입니다.");ㄴ}
//		}
