...
public class A_For { // A_For 클래스 영역 시작
	 ...
	 * }
	 * 
	 * - 초기식: 반복문이 시작될 때 '초기에 단 한 번만 실행'될 구문; 반복문에서 사용할 변수를 선언하고 초기화(initialization)하는 구문
	 *  e.g. int i = 0;
	 *  
	...
	public void method1() { // method1 영역 시작
		...
		for(/*초기식*/; /*조건식*/; /*증감식*/) {
			System.out.println("안녕하세요");
		} // 이 상태로 호출/실행하면 무한한 인사 -> console창 빨간색 네모 클릭 -> 빨간 버튼 안 먹으면 ctrl+Z(Eclipse 강제 종료) 
