...
public class Run {
	 ...
	 * 2. 클래스 내부에서 간접적으로 값을 처리할 수 있는 메소드(getter(값 가져오기), setter(값 대입))를 만듦
	 */
	...
	public static void main(String[] args) {
		...
		/*
		lee.name = "김선민"; // 개인정보인데 누구나 와서 변경하면 보안 문제 vs 무분별한 수정을 막기 위해 private 멤버변수로 바꿔 설정하면 필드가 보이지 않아 오류 발생 -> 직접 접근 불가능함
		lee.age = 46;
		lee.gender = 'F';
