...
public class MethodTest1 {
	...
	/* method(메소드, 메서드): 기능, 마술상자; 입력을 가지고 어떤 일을 수행한 다음에 결과물을 내놓음
	 * 
	 * 표현법
	 * 접근제한자 예약어(e.g. static) 반환형(내놓는 결과물/반환할 값의 자료형) 메소드이름(매개변수의자료형 매개변수이름) {
	 * 		수행할 코드;
	 * 		return 반환값;
	 * }
	...
	// 1. 매개변수가 없고 반환값도 없는 메소드; 절차 지향적 프로그래밍으로 배울 때 계속 만들었던 것
	public void method1() {
