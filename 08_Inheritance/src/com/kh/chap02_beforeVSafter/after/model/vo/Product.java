 ...
 * -> 3개 클래스에 중복되는 codes/부분들(필드 4개 선언, 매개변수 생성자 초기화 4줄, 공통 필드 4개의 setters 및 getters, information 메서드 일부..)을 하나의 클래스(Product 클래스)에 모아보자
 * -> Desktop, SmartPhone, Tv는 이제 Product 클래스의 내용이 필요하다 -> '상속'
 */

// 부모(parent)-자식(child)클래스(Java에서 많이 사용하는 표현) 
// 조상-후손 클래스
// 상위-하위 클래스
// 슈퍼-서브 클래스
// 확장-파생 클래스
